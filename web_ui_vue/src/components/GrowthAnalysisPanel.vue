  ...
  <v-card class="app-card">
    <v-card-title class="d-flex align-center p-lg">
      ...
      <v-sheet class="flex-grow-1" color="transparent">
        <v-card-text class="text-h6 font-weight-bold pa-0">增长率分析</v-card-text>
      ...
      <v-row>
        ...
        <v-col cols="12" md="4">
          <v-card variant="outlined" class="text-center pa-4">
            <v-sheet class="d-flex align-center justify-center mb-2" color="transparent">
              <v-icon
                ...
                class="me-2"
              />
              <v-chip class="text-subtitle-2 text-on-surface-variant" variant="text" size="small"
                >日增长率</v-chip
              >
            </v-sheet>
            <v-card-text
              class="text-h5 font-weight-bold mb-1 pa-0"
            ...
            <v-card-text
              v-if="dailyGrowth.latest"
              class="text-caption text-on-surface-variant mt-2 pa-0"
            >
          ...
          <v-card variant="outlined" class="text-center pa-4">
            <div class="d-flex align-center justify-center mb-2">
              <v-icon
                ...
                class="me-2"
              />
              <span class="text-subtitle-2 text-on-surface-variant"
                >周增长率</span
              >
            </div>
            <div
            ...
            <div
              v-if="weeklyGrowth.latest"
              class="text-caption text-on-surface-variant mt-2"
            >
            ...
            <v-card-text>
              <div class="analysis-timeline">
                <div
                  ...
                  :class="{
                    'border-bottom':
                      index < selectedAnalysis.data.slice(-5).length - 1,
                  }"
                >
                  <div class="flex-grow-1">
                    ...
                    <div class="text-caption text-on-surface-variant">
                      ...
                      <span v-if="item.previousValue"
                        >(前期: {{ formatValue(item.previousValue) }})</span
                      >
                    </div>
                  </div>
