<template>
  <v-container fluid>
    ...
    <v-sheet class="app-section" color="transparent">
      <v-sheet class="d-flex align-center" color="transparent">
        ...
        <v-sheet class="flex-grow-1" color="transparent">
          <h1 class="text-h4 font-weight-medium mb-1">仪表板</h1>
          <v-card-text class="text-subtitle-1 text-medium-emphasis pa-0">
            系统概览和实时状态监控
          </v-card-text>
        </v-sheet>
        <v-chip
    ...
    <v-row class="app-section">
      <v-col cols="12" sm="6" md="3">
        ...
        >
          <v-card-text class="p-lg">
            ...
            <div
              class="text-h3 font-weight-medium mb-2 text-on-primary-container"
            >
              {{ appStore.systemStats.totalProjects }}
            </div>
            <div
              class="text-subtitle-1 mb-1 font-weight-medium text-on-primary-container"
            >
              总项目数
            </div>
      ...
      <v-col cols="12" sm="6" md="3">
        ...
        >
          <v-card-text class="p-lg">
            ...
            <div
              class="text-h3 font-weight-medium mb-2 text-on-secondary-container"
            >
              {{ appStore.systemStats.todayProjects }}
            </div>
            <div
              class="text-subtitle-1 mb-1 font-weight-medium text-on-secondary-container"
            >
              今日新增
            </div>
            <div class="text-body-2 text-medium-emphasis">
      ...
      <v-col cols="12" sm="6" md="3">
        ...
        >
          <v-card-text class="p-lg">
            ...
            <div
              class="text-h3 font-weight-medium mb-2 text-on-success-container"
            >
              {{ appStore.systemStats.weekProjects }}
            </div>
            <div
              class="text-subtitle-1 mb-1 font-weight-medium text-on-success-container"
            >
              本周新增
            </div>
            <div class="text-body-2 text-medium-emphasis">
      ...
      <v-col cols="12" sm="6" md="3">
        <v-card color="info-container" class="app-card stats-card text-center">
          <v-card-text class="p-lg">
            <v-avatar color="info" size="80" class="mb-4">
              <v-icon icon="mdi-cog" :size="statsIconSize" color="on-info" />
            </v-avatar>
            <div class="text-h3 font-weight-medium mb-2 text-on-info-container">
              {{ appStore.systemStats.activeTasks }}
            </div>
            <div
              class="text-subtitle-1 mb-1 font-weight-medium text-on-info-container"
            >
              活跃任务
            </div>
            <div class="text-body-2 text-medium-emphasis">
    ...
    <v-row>
      ...
      <v-col cols="12" md="8" lg="8" xl="9" xxl="9">
        <v-card class="mb-4" elevation="0" rounded="xl">
          <v-card-title class="d-flex align-center pa-6">
            ...
            <v-sheet class="flex-grow-1" color="transparent">
              <v-card-text class="text-h6 font-weight-bold pa-0">当前任务状态</v-card-text>
              ...
              <div class="mb-4">
                <div class="d-flex justify-space-between mb-2">
                  ...
                  <span class="text-subtitle-2"
                    >{{ Math.round(appStore.currentTask.progress) }}%</span
                  >
                </div>
                <v-progress-linear
      ...
      <v-col cols="12" md="4" lg="4" xl="3" xxl="3">
        ...
        <!-- 快速操作 -->
        <v-card elevation="0" class="mb-4" rounded="xl">
          <v-card-title class="pa-6">
...
const statsIconSize = getResponsiveSize({
  xs: 40,
  sm: 48,
  md: 56,
  lg: 56,
