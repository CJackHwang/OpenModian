<template>
  <v-container class="component-test-page" fluid>
    <v-container fluid>
      <!-- 页面标题 -->
      <v-row class="mb-4">
        <v-col>
      ...
      <v-row class="mb-4">
        <v-col cols="12">
          <v-card elevation="2">
            <v-card-title> 单个组件测试 - 高度: {{ testHeight }} </v-card-title>
      ...
      <v-row>
        <v-col cols="12" md="6">
          <v-card elevation="2">
            <v-card-title> 左侧组件 - 自适应高度 </v-card-title>
            <v-card-text class="pa-2">
              <RealTimeLogViewer
                height="auto"
                :min-height="'250px'"
        ...
        <v-col cols="12" md="6">
          <v-card elevation="2">
            <v-card-title> 右侧组件 - 固定高度 </v-card-title>
            <v-card-text class="pa-2">
              <RealTimeLogViewer
                height="350px"
                :max-logs="100"
          ...
          <v-card elevation="1">
            <v-card-text>
              <v-card-text class="text-caption pa-0">
                ...
                宽度: {{ display.width.value }}px | 高度:
                {{ display.height.value }}px | 断点: {{ currentBreakpoint }} |
